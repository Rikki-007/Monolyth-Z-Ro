...
export function WhatsappIcon({ size = 18, className }: IconProps) {
  return (
    <svg
      ...
      className={className}
    >
      <path d="M20.5 11.5a8.5 8.5 0 0 1-12.4 7.5L3 20l1.1-5A8.5 8.5 0 1 1 20.5 11.5z" />
      <path d="M8.5 8.5c0 4 3.5 7.5 7.5 7.5.7 0 1-.6.8-1.3l-.5-1.4a1 1 0 0 0-1.1-.6l-1.2.3a5 5 0 0 1-2.5-2.5l.3-1.2a1 1 0 0 0-.6-1.1L9.8 7.7c-.7-.2-1.3.1-1.3.8z" />
    </svg>
  );
}
